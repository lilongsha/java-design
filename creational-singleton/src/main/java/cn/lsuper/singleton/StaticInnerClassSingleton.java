 ...
 * 这种方式同样利用了 classloader 机制来保证初始化 instance 时只有一个线程，它跟第 3 种方式不同的是：第 3 种方式只要 Singleton 类
 * 被装载了，那么 instance 就会被实例化（没有达到 lazy loading 效果），而这种方式是 Singleton 类被装载了，instance 不一定被初始化。
...
public class StaticInnerClassSingleton {
    ...
    public void showMessage() {
        System.out.println("StaticInnerClassSingleton say Hello World!");
    }
}
